	...
	<td>
		...
		<?php else : ?>
			...
			<?php if ( is_cart() ) : ?>
				...
				<?php if ( $quantity <= 5 && !preg_match($pattern, $subject) ) : ?>
					<?php echo apply_filters( 'woocommerce_cart_no_shipping_available_html',
						'<p>' . __( 'You must order more than <b>5 units</b> in your area, please contact us on <b>02 8710 4490</b>.', 'woocommerce' ) . '</p>'
					); ?>
				...
				<?php else: ?>
					<?php if ( preg_match( $pattern, $subject ) ) : ?>
						<?php echo apply_filters( 'woocommerce_no_shipping_available_html',
							'<p>' . __( 'You ordered more than <b>10 units</b>, Please call us on <b>02  8710 4490</b>. We will help you arrange the courier with discount.', 'woocommerce' ) . '</p>'
						); ?>
					<?php else: ?>
						<?php echo apply_filters( 'woocommerce_no_shipping_available_html',
							'<p>' . __( 'You ordered more than <b>5 units</b>, Please call us on <b>02  8710 4490</b>. We will help you arrange the courier with discount.', 'woocommerce' ) . '</p>'
						); ?>
					<?php endif ?>
				<?php endif ?>
